...
[![Version](https://img.shields.io/npm/v/react-native-nitro-dpi-metric.svg)](https://www.npmjs.com/package/react-native-nitro-dpi-metric)
[![Downloads](https://img.shields.io/npm/dm/react-native-nitro-dpi-metric.svg)](https://www.npmjs.com/package/react-native-nitro-dpi-metric)
[![License](https://img.shields.io/npm/l/react-native-nitro-dpi-metric.svg)](https://github.com/tconns/react-native-nitro-dpi-metric/LICENSE)
...
```sh
npm install react-native-nitro-dpi-metric react-native-nitro-modules
# or
yarn add react-native-nitro-dpi-metric react-native-nitro-modules
```
...
import {
  ...
  getDpi,
  cmToPx
} from 'react-native-nitro-dpi-metric';
...
```ts
import { isTablet, deviceInch } from 'react-native-nitro-dpi-metric';
...
```ts
import { cmToPx, getDpi } from 'react-native-nitro-dpi-metric';
...
```ts
import { getNavBarHeight, isTablet } from 'react-native-nitro-dpi-metric';
